...
//        setActionBar()
//
//        findViewById<CircleImageView>(R.id.create_board_image).setOnClickListener {
...
//        setSupportActionBar(findViewById<Toolbar>(R.id.toolbar_create_board_activity))
...
//                    .into(findViewById<CircleImageView>(R.id.create_board_image))
//            } catch (e: IOException) {
//                e.printStackTrace()
//            }
//        }
...
class CreateBoardActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<Button>(R.id.create_board_create_btn).setOnClickListener {
    ...
    private fun createBoard() {
        ...
        var board = Board(
            findViewById<AppCompatEditText>(R.id.create_board_name_et).text.toString(),
            mBoardImageURL,
            mUserName,
            assignedUsers
        )
        ...
        if (resultCode == Activity.RESULT_OK
            ...
            try {
                Glide.with(this)
                    ...
                    .fitCenter()
                    .placeholder(R.drawable.ic_board_place_holder)
                    .into(findViewById(R.id.create_board_image))
            } catch (e: IOException) {
                e.printStackTrace()
            }
        }
    ...
    private fun setFonts() {
        ...
        findViewById<AppCompatEditText>(R.id.create_board_name_et).typeface = regularFont
        findViewById<Button>(R.id.create_board_create_btn).typeface = regularFont
    }
